...
export default function  AddSTiming(){
    ...
    const handleSubmit = (event) => {
      ...
      axios
        .post(
          `http://localhost/students/Guacuco/api/security/fetch_timings_profile.php`,
          inputs
        )
        .then((response) => { 
          navigate('/s-timing');
          ...
          <div className="b-add-form-forms">
            <form onSubmit={handleSubmit}>
              <div className="form-group">
                ...
                <select name="week_day" id=""  onChange={handleChange} className="form-control" required>
