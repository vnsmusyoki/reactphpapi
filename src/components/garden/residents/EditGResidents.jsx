...
export default function EditGResident() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(
        `http://localhost/students/Guacuco/api/garden/fetch_resident_profile.php/${id}/edit`,
        inputs
      )
      .then((response) => {
        // window.location.href="/s-security";
        navigate("/g-residents");
      ...
      <div className="b-search">
        <div className="search-details">
          ...
          <div className="search-manager">
            <Link to="/g-residents">Return Back</Link>
          </div>
        </div>
      </div>
