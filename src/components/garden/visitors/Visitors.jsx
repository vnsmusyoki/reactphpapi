...
export default function GVisitors() {
  ...
  const deleteResident = (id) => {
    axios
      .delete(
        `http://localhost/students/Guacuco/api/garden/fetch_visitors_profile.php/${id}`
      )
  ...
  const checkout = (id) => {
    axios
      .delete(
        `http://localhost/students/Guacuco/api/garden/checkout_visitors_profile.php/${id}`
      )
      .then(function (response) {
        // console.log(response.data);
        document.getElementById("error-display").classList.remove("hidden");
      ...
      <div className="b-search">
        <div className="search-details">
          ...
          <div className="search-manager"> 
            <Link to='/g-visitors/add'>Check In New Visitor</Link>
          </div>
        </div>
      </div>
      <div
            ...
            {users.map((user, key) => {
              return (
                <tr key={key}>
                  ...
                  <td>{user.gender}</td> 
                  <td>
                    <Link to={`/g-edit-visitors/${user.id}/edit`}>Edit</Link>
                  </td>
                  <td>
