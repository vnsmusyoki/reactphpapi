...
export default function EditBGarden() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(
        `http://localhost/students/Guacuco/api/building/fetch_gardener_profile.php/${id}/edit`,
        inputs
      )
      .then((response) => { 
        navigate('/b-gardens');
        ...
        <div className="b-add-form-forms">
          <form onSubmit={handleSubmit}>
            ...
            <div className="b-add-form-send-btn">
              <button>Edit   Gardener Account</button>
            </div>
          </form>
        </div>
      </div>
