...
export default function EditBResident() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(
        `http://localhost/students/Guacuco/api/security/fetch_resident_profile.php/${id}/edit`,
        inputs
      )
      .then((response) => {
        // window.location.href="/s-security";
        navigate("/b-residents");
      ...
      <div className="b-search">
        <div className="search-details">
          ...
          <div className="search-manager">
            <Link to="/s-residents">Return Back</Link>
          </div>
        </div>
      </div>
